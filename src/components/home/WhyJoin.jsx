const WhyJoin = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center bg-gardening-yellow-100 border-y-8 border-gardening-yellow-200">
      <p className="text-5xl font-bold text-center text-gardening-white-100 my-12">
        Why Join?
      </p>

      <div className="w-5/6 flex justify-between mb-10">
        <div className="w-1/6 flex flex-col items-center justify-center rounded-full border-gardening-yellow-200 border-4 bg-gardening-white-100 py-2">
